...
SymbolicAbstraction provides a command-line tool for running abstract interpretation
...
.. code-block:: bash
   ...
   ./build/bin/symbolic_abstraction --config config/symbolic_abstraction/01_const_function.conf example.bc
...
.. code-block:: bash
   ...
   ./build/bin/symbolic_abstraction --list-domains

   # List available configuration files
   ./build/bin/symbolic_abstraction --list-configs

   # List functions in a module
   ./build/bin/symbolic_abstraction --list-functions example.bc

Configuration Files
-------------------

SymbolicAbstraction uses configuration files (``.conf``) to specify analysis parameters.
Configuration files are located in ``config/symbolic_abstraction/``.
