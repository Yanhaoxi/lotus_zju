...
#include <Utils/General/spdlog/details/fmt_helper.h>
#include <Utils/General/spdlog/details/log_msg.h>
#include <Utils/General/spdlog/details/os.h>
#include <Utils/General/spdlog/fmt/fmt.h>
#include <Utils/General/spdlog/formatter.h>
...
public:
    ...
    void format(const details::log_msg &msg, const std::tm &, memory_buf_t &dest) override {
        ...
        size_t text_size = padinfo_.enabled() ? std::char_traits<char>::length(msg.source.filename) +
