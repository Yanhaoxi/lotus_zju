 ...
 * @brief Top-level SymbolicAbstraction context for an LLVM module, owning the Z3 context,
...
/**
 * Encapsulates module-wide state needed by SymbolicAbstraction analyses.
 *
