...
#ifdef ENABLE_DYNAMIC
CEREAL_REGISTER_TYPE(sprattus::domains::ValidRegion);
CEREAL_REGISTER_TYPE(sprattus::domains::NoAlias);
CEREAL_REGISTER_TYPE(sprattus::domains::VariableRegion);
CEREAL_REGISTER_TYPE(sprattus::domains::RestrictedVarRegion);
CEREAL_REGISTER_TYPE(sprattus::domains::ConstantRegion);
CEREAL_REGISTER_TYPE(sprattus::domains::MemoryRegion);
#endif
