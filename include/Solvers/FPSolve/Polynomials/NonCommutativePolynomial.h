/**
 * Non-commutative polynomial for FPSolve
 */

#ifndef FPSOLVE_NON_COMMUTATIVE_POLYNOMIAL_H
#define FPSOLVE_NON_COMMUTATIVE_POLYNOMIAL_H
...
#endif // FPSOLVE_NON_COMMUTATIVE_POLYNOMIAL_H
