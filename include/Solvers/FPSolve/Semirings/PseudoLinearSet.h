#ifndef FPSOLVE_PSEUDO_LINEAR_SET_H
#define FPSOLVE_PSEUDO_LINEAR_SET_H
...
class PseudoLinearSet : public StarableSemiring< PseudoLinearSet<Var, Value, VecDivider,
  ...
  public:
    ...
    // NOTE: Without GENEPI, this is syntactic equality only (not semantic)
...
#endif // FPSOLVE_PSEUDO_LINEAR_SET_H
