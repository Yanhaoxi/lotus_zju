 ...
 * @brief LLVM function pass that drives the SymbolicAbstraction analyzer and
 * rewrites IR.
 */
#pragma once
...
/**
 * Runs the SymbolicAbstraction abstract interpreter on a single function and
...
private:
   ...
   */
  DomainConstructor
  getAugmentedDomain(symbolic_abstraction::FunctionContext &smtsem);
