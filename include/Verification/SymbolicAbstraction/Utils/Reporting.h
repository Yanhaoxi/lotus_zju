// SymbolicAbstraction reporting helpers: configuration and analysis result
// rendering
#pragma once
...
void printEntryResult(symbolic_abstraction::Analyzer *analyzer,
                      llvm::Function *func);

// Pretty-print analysis results for all basic blocks.
void printAllBlocksResults(symbolic_abstraction::Analyzer *analyzer,
                           llvm::Function *func);

// Pretty-print analysis results for exit blocks (with return).
void printExitBlocksResults(symbolic_abstraction::Analyzer *analyzer,
                            llvm::Function *func);
