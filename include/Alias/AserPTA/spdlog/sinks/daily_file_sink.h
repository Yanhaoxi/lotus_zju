...
#include <Alias/AserPTA/spdlog/details/file_helper.h>
#include <Alias/AserPTA/spdlog/details/null_mutex.h>
#include <Alias/AserPTA/spdlog/details/os.h>
#include <Alias/AserPTA/spdlog/details/synchronous_factory.h>
#include <Alias/AserPTA/spdlog/fmt/fmt.h>
#include <Alias/AserPTA/spdlog/sinks/base_sink.h>
...
struct daily_filename_calculator {
    ...
    static filename_t calc_filename(const filename_t &filename, const tm &now_tm) {
        ...
        return fmt::format(SPDLOG_FILENAME_T("{}_{:04d}-{:02d}-{:02d}{}"), basename, now_tm.tm_year + 1900,
...
inline std::shared_ptr<logger> daily_logger_mt(const std::string &logger_name, const filename_t &filename, int hour = 0,
...
template <typename Factory = spdlog::synchronous_factory>
inline std::shared_ptr<logger> daily_logger_st(const std::string &logger_name, const filename_t &filename, int hour = 0,
                                               int minute = 0, bool truncate = false) {
