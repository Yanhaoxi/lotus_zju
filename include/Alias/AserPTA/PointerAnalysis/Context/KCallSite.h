...
#include "Alias/AserPTA/PointerAnalysis/Context/PtrRingBuffer.h"
...
template <uint32_t K>
const KCallSite<K> CtxTrait<KCallSite<K>>::initCtx{};

template <uint32_t K>
const KCallSite<K> CtxTrait<KCallSite<K>>::globCtx{};
