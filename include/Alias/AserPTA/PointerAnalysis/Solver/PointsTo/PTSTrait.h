...
extern const NodeID NULL_PTR;
extern const NodeID UNI_PTR;
extern const NodeID NULL_OBJ;
extern const NodeID UNI_OBJ;
extern const NodeID NORMAL_NODE_START_ID;
