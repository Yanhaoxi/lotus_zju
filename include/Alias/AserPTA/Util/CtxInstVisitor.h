...
#include "llvm/IR/Instruction.def"
    ...
    RetTy visitFreezeInst(FreezeInst &I, const ctx *context) { DELEGATE(Instruction); }
    ...
    RetTy visitCallBrInst(CallBrInst &I, const ctx *context) {
        return static_cast<SubClass *>(this)->visitCallSite(&I, context);
    }

    // Call and Invoke are slightly different as they delegate first through
    // a generic CallSite visitor.
    RetTy visitCallInst(CallInst &I, const ctx *context) {
        return static_cast<SubClass *>(this)->visitCallSite(&I, context);
    }
    ...
    RetTy visitCallSite(CallBase *CS, const ctx *context) {
        assert(CS);
        return static_cast<SubClass *>(this)->visitCallBase(*CS, context);
    }
