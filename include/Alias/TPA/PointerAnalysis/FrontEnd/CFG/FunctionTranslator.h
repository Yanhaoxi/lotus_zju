...
private:
  ...
  llvm::DenseMap<const llvm::BasicBlock *, std::pair<CFGNode *, CFGNode *>>
      bbToNode;
  llvm::DenseMap<const llvm::BasicBlock *, std::vector<CFGNode *>>
      nonEmptySuccMap;
...
public:
  FunctionTranslator(CFG &c, InstructionTranslator &t)
      : cfg(c), translator(t) {}
