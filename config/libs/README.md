...
When analyzing LLVM IR, it is often have call-sites that call a function contained in one of those
...
But default, we can  models calls to these functions as identity.
But the specific algorithmic components could specify a different behavior if desired.