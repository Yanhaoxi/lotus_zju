...
#ifdef ENABLE_DYNAMIC
CEREAL_REGISTER_TYPE(sprattus::RVExpression);
CEREAL_REGISTER_TYPE(sprattus::ConstantExpression);
CEREAL_REGISTER_TYPE(sprattus::BinopExpression);
CEREAL_REGISTER_TYPE(sprattus::Conversion);
#endif
