 ...
 * @brief Implementation of the SymbolicAbstraction optimization pass on top of
 * SymbolicAbstraction abstract interpretation results.
 */
 ...
 */
template <typename T>
bool containsDomain(const symbolic_abstraction::AbstractValue *value) {
  bool res = false;
...
SymbolicAbstractionPass::SymbolicAbstractionPass()
    : llvm::FunctionPass(SymbolicAbstractionPass::ID) {
 ...
 */
DomainConstructor SymbolicAbstractionPass::getAugmentedDomain(
    symbolic_abstraction::FunctionContext &smtsem) {
...
bool SymbolicAbstractionPass::replaceUsesOfWithInBBAndPHISuccs(BasicBlock &bb,
                                                               Value *from,
                                                               Value *to) {
  bool changed = false;
...
void SymbolicAbstractionPass::insertEquality(equals_t &eqs, Value *a,
                                             Value *b) {
...
Value *SymbolicAbstractionPass::getReplacementCanditdate(const equals_t &eqs,
                                                         Value *val) {
...
bool SymbolicAbstractionPass::runOnFunction(llvm::Function &function) {
  vout << "Perform SymbolicAbstractionPass on function `"
