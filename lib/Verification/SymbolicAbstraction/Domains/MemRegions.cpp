...
DomainConstructor::Register ValidRegion(
    ...
    " memory region",
    [](const FunctionContext &fctx, llvm::BasicBlock *loc, bool after) {
      return params::ForPointers<symbolic_abstraction::domains::ValidRegion>(
          fctx, loc, after);
    });
...
DomainConstructor::Register ConstRegion(
    ...
    [](const FunctionContext &fctx, llvm::BasicBlock *loc, bool after) {
      return params::ForPointers<symbolic_abstraction::domains::ConstantRegion>(
          fctx, loc, after);
    });
...
DomainConstructor::Register VarRegion(
    ...
    [](const FunctionContext &fctx, llvm::BasicBlock *loc, bool after) {
      return ForPointerSizePairs<symbolic_abstraction::domains::VariableRegion>(
          fctx, loc, after);
    });
