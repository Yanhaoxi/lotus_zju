...
static void listConfigurationFiles() {
    const char* configDirs[] = {"../config/symbolic-abstraction", "../../config/symbolic-abstraction", 
                                "../../../config/symbolic-abstraction", "./config/symbolic-abstraction"};
    ...
    if (!foundAny) {
        outs() << "No configuration files found in config/symbolic-abstraction/\n";
    }
    outs() << "\nSee config/symbolic-abstraction/README.md for details.\n";
}
...
static cl::opt<std::string> ConfigFile(
    "config",
    cl::desc("Configuration file (see config/symbolic-abstraction/ for examples)"),
    cl::value_desc("file"));
...
int main(int argc, char** argv) {
    cl::ParseCommandLineOptions(argc, argv, 
        "SymbolicAbstraction Static Analyzer - Abstract Interpretation for LLVM IR\n");
