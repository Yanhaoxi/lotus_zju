 ...
 * This file implements the main driver for running null pointer analysis
 * (both context-insensitive and context-sensitive) on LLVM bitcode files.
 * It parses command-line options, loads the input module, runs the selected
